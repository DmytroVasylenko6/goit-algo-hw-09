...
if __name__ == "__main__":
    ...
    print(
        "{:<24}".format("Greedy algorithm"),
        "{:<50}".format(f"Coin combinations: {greedy_sm_coin_combinations}"),
        f"Time: {greedy_sm:.6f} sec",
    )
    print(
        "{:<24}".format("Greedy algorithm:"),
        "{:<50}".format(f"Coin combinations: {greedy_md_coin_combinations}"),
        f"Time: {greedy_md:.6f} sec",
    )
    print(
        "{:<24}".format("Greedy algorithm:"),
        "{:<50}".format(f"Coin combinations: {greedy_lg_coin_combinations}"),
        f"Time: {greedy_lg:.6f} sec",
    )
    # Results for different exchange amounts made with the dynamic programming algorithm
    print(
        "{:<24}".format("Dynamic programming:"),
        "{:<50}".format(f"Coin combinations: {dynamic_sm_coin_combinations}"),
        f"Time: {dynamic_sm:.6f} sec",
    )
    print(
        "{:<24}".format("Dynamic programming:"),
        "{:<50}".format(f"Coin combinations: {dynamic_md_coin_combinations}"),
        f"Time: {dynamic_md:.6f} sec",
    )
    print(
        "{:<24}".format("Dynamic programming:"),
        "{:<50}".format(f"Coin combinations: {dynamic_lg_coin_combinations}"),
        f"Time: {dynamic_lg:.6f} sec",
    )

    # Simple
    print(
        "{:<75}".format("Simple amount (greedy):"),
        f"Time: {greedy_simple:.6f} sec",
    )
    print(
        "{:<75}".format("Simple amount (dynamic):"),
        f"Time: {dynamic_simple:.6f} sec",
    )
